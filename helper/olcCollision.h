...
#ifndef AMONG_US_STE_EDITION_OLCCOLLISION_H
#define AMONG_US_STE_EDITION_OLCCOLLISION_H
...
//                return false;
            ...
            if (RayVsRect(r_dynamic->pos + r_dynamic->size / 2, r_dynamic->vel * fTimeStep, &expanded_target, contact_point, contact_normal, contact_time))
                return (contact_time >= -1.0f && contact_time < 1.0f);
            else
                return false;
        }
...
#endif //AMONG_US_STE_EDITION_OLCCOLLISION_H
